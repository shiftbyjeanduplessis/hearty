(function () {
  ...
  function startFoundationWorkout(workoutId) {
    ...
    if (existing && !confirm('You already have a workout in progress. Start a new one and replace the saved workout?')) return;
  ...
  function startGymWorkout() {
    ...
    if (existing && !confirm('You already have a gym workout in progress. Start a new one and replace the saved workout?')) return;
