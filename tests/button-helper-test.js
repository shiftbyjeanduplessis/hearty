...
const checks = [
  ...
  ["next handler has error logging", html.includes("HEARTY_WIZARD_NEXT_ERROR")],
  ["v3.3.6 engine script", html.includes("hearty-meal-engine-final.js?v=3.3.6-button-helper-fix")],
