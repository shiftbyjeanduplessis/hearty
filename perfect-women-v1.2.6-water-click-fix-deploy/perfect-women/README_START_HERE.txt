...
V1.2.5 update:
- Added selected non-duplicate autumn recipes from the old Autumn Recipe Book.
- Recipe library now includes 43 total recipes.
- Skipped close duplicates and adapted higher-calorie classics with clearer plan notes.
